...
<body>
    ...
    $jawabanEmpty = "Empty adalah = Berfungsi sebagi penanda suatu kondisi. Coontohnya yang sering kita temukan adalah dalam pengisian suatu data, apakah data tersebut ada isinya atau tidak.";
